...
def test_addition_operation():
    ...
    """
    calc = Calculation.create(Decimal('3'), Decimal('2'), add, 'add')
...
def test_subtraction_operation():
    ...
    """
    calc = Calculation.create(Decimal('7'), Decimal('2'), subtract, 'subtract')
    assert calc.perform() == Decimal('5')
...
def test_multiplication_operation():
    ...
    """
    calc = Calculation.create(Decimal('4'), Decimal('2'), multiply, 'multiply')
...
def test_division_operation():
    ...
    """
    calc = Calculation.create(Decimal('6'), Decimal('2'), divide, 'divide')
...
def test_divide_by_zero():
    ...
    with pytest.raises(ValueError, match=r"Cannot divide by zero\."):
        calc = Calculation.create(Decimal('7'), Decimal('0'), divide, 'divide')
        calc.perform()
